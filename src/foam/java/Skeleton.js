...
//        type: this.of.id
  ...
  for ( var i = 0 ; i < methods.length ; i++ ) {
    ...
    <%
      ...
      foam.nanos.logger.Loggers.logger(getMessageX(message), this).warning(rpc.getName(), "returning exception", t.toString(), t);
    ...
    if ( replyBox != null ) {
      ...
      <% if ( anyHasReturn ) { %>if ( result != null ) {
        foam.nanos.logger.Loggers.logger(getMessageX(message), this).debug(rpc.getName(), result);
