...
foam.CLASS({
  ...
  properties: [
    ...
    },
    {
      ...
      `,
      preSet: function(o, n) {
        if ( this.isSetFromPredicate || this.inclusive )
          return n;
        var n1 = new Date(n);
    ...
    },
    {
      ...
      name: 'inclusive',
      documentation: `
        When true and qualifier is 'Bt', the between filter will be inclusive (>=, <=).
        When false, the between filter will be exclusive (>, <).
      `,
      value: false
    },
    {
