...
foam.CLASS({
  ...
  methods: [
    function getExportMap() {
      var m  = {};
      var bs = this.cls_.getAxiomsByClass(foam.lang.Export);
  ...
  properties: [
    {
      ...
      adaptArrayElement: function(o) {
        if ( foam.String.isInstance(o) ) {
          ...
          return foam.lang.Import.create({name: name || key, key: key, required: ! optional, javaType: javaType || 'null'});
        }

        return foam.lang.Import.create(o);
      }
    },
    {
      class: 'AxiomArray',
      ...
      adaptArrayElement: function(o) {
        if ( typeof o === 'string' ) {
          ...
          switch ( a.length ) {
            case 1:
              return foam.lang.Export.create({exportName: a[0], key: a[0]});
            ...
            case 2:
              ...
              return foam.lang.Export.create({exportName: a[1], key: null});

            case 3:
              foam.assert(
                a[1] === 'as',
                'Invalid export syntax: key [as value] | as value');
              return foam.lang.Export.create({exportName: a[2], key: a[0]});
        ...
        return foam.lang.Export.create(o);
      }
    }
  ]
});
