...
import foam.core.ruler.RuleEngine;
import foam.core.ruler.RuleHistory;
import foam.core.ruler.RuleHistoryStatus;
    ...
    ruleHistoryDAO.where(
      ...
      public void put(Object obj, Detachable sub) {
        ...
        try {
          ...
          if ( rule == null ) {
            throw new Exception(
              String.format("Rule with id %s is not found.",
          ...
          if ( object == null ) {
            throw new Exception(
              String.format("Object with id %s in %s is not found.",
