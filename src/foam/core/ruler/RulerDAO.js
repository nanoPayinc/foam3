...
return ret;`
    },
    {
      name: 'applyRules',
      type: 'boolean',
      args: 'Context x, foam.lang.FObject obj, foam.lang.FObject oldObj, Predicate pred',
...
for ( var groupId : groupIds ) {
  ...
  javaCode: `
    public RulerDAO(foam.lang.X x, foam.dao.DAO delegate, String serviceName) {
      setX(x);
