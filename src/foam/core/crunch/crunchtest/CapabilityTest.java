...
import foam.core.auth.CapabilityAuthService;
...
public class CapabilityTest extends Test {
  ...
  public void runTest(X x) {
    ...
    DAO dao = new foam.core.crunch.PredicatedPrerequisiteCapabilityJunctionDAO.Builder(x).setDelegate(new MDAO(CapabilityCapabilityJunction.getOwnClassInfo())).build();
    x = x.put("prerequisiteCapabilityJunctionDAO", dao);
    dao = new foam.core.crunch.UserCapabilityJunctionDAO.Builder(x).setDelegate(new MDAO(UserCapabilityJunction.getOwnClassInfo())).build();
