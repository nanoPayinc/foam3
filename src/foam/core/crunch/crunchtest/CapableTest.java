...
import foam.core.crunch.MinMaxCapability;
import foam.core.crunch.CapabilityCapabilityJunction;
import foam.core.crunch.UserCapabilityJunction;
import foam.core.crunch.CapabilityJunctionPayload;
import foam.core.crunch.lite.Capable;
...
public class CapableTest extends Test {
  ...
  public X createTestX(X x) {
    ...
    DAO dao = new foam.core.crunch.PredicatedPrerequisiteCapabilityJunctionDAO.Builder(x).setDelegate(new foam.dao.MDAO(CapabilityCapabilityJunction.getOwnClassInfo())).build();
