...
foam.CLASS({
  package: 'foam.core.analytics.test',
  ...
  methods: [
    {
      ...
      javaCode: `
        ...
        DAO analyticEventDAO = new foam.core.auth.AuthorizationDAO.Builder(y)
           .setDelegate(rawAnalyticEventDAO)
           .setAuthorizer(new foam.core.auth.AuthorizableAuthorizer(AnalyticEvent.class.getSimpleName().toLowerCase()))
           .build();
